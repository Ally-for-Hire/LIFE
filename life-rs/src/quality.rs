...
use crate::brain::{Brain, N_EXPERTS, N_IN};
...
impl QualityScore {
    pub fn niche_scores(self) -> [f32; N_STRATEGY_NICHES] {
        [
            ...
            self.cooperation * 0.55 + self.survival * 0.30 + self.security * 0.15,
    ...
    pub fn qualifies_for(self, niche: StrategyNiche) -> bool {
        ...
        match niche {
            ...
            StrategyNiche::Cooperator => self.cooperation >= 0.04,
...
pub fn score_clan(w: &World, cid: i32) -> QualityScore {
    ...
    let cooperation = (recruits / (recruits + 8.0)).clamp(0.0, 1.0);
